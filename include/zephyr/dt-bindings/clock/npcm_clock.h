...
/* clock on and off */
#define NPCM_CLOCK_PWDWN(N, M) (((N) << 3) + M)
...
#define NPCM_CLOCK_CFG(bus, pwr_valid, pwr_indx, pwr_bit) \
		((bus << NPCM_CLOCK_BUS_OFFSET) + \
		(pwr_valid << NPCM_CLOCK_PWDWN_VALID_OFFSET) + \
...
#define NPCM_CLOCK_MFT1    NPCM_CLOCK_CFG(NPCM_CLOCK_BUS_APB2, 1, 1, 5)
#define NPCM_CLOCK_MFT2    NPCM_CLOCK_CFG(NPCM_CLOCK_BUS_APB2, 1, 1, 6)
#define NPCM_CLOCK_MFT3    NPCM_CLOCK_CFG(NPCM_CLOCK_BUS_APB2, 1, 1, 7)
