...
#ifndef _NUVOTON_NPCM4XX_SOC_MIWU_H_
#define _NUVOTON_NPCM4XX_SOC_MIWU_H_
...
enum miwu_table {
	NPCM4XX_MIWU_TABLE_0,
	NPCM4XX_MIWU_TABLE_1,
	NPCM4XX_MIWU_TABLE_2,
	NPCM4XX_MIWU_TABLE_COUNT
};

enum miwu_group {
	NPCM4XX_MIWU_GROUP_1,
	NPCM4XX_MIWU_GROUP_2,
	NPCM4XX_MIWU_GROUP_3,
	NPCM4XX_MIWU_GROUP_4,
	NPCM4XX_MIWU_GROUP_5,
	NPCM4XX_MIWU_GROUP_6,
	NPCM4XX_MIWU_GROUP_7,
	NPCM4XX_MIWU_GROUP_8,
	NPCM4XX_MIWU_GROUP_COUNT
};

#define NPCM4XX_MIWU_TABLE_NONE NPCM4XX_MIWU_TABLE_COUNT

/* Interrupt modes supported by npcm4xx miwu modules */
enum miwu_int_mode {
	NPCM4XX_MIWU_MODE_LEVEL,
	NPCM4XX_MIWU_MODE_EDGE,
};

/* Interrupt trigger modes supported by npcm4xx miwu modules */
enum miwu_int_trig {
	NPCM4XX_MIWU_TRIG_LOW,  /** Edge failing or active low detection */
	NPCM4XX_MIWU_TRIG_HIGH, /** Edge rising or active high detection */
	NPCM4XX_MIWU_TRIG_BOTH, /** Both edge rising and failing detection */
};

/**
 * @brief NPCM4XX wake-up input source structure
 *
...
/**
 * Define npcm4xx miwu driver callback handler signature for wake-up input source
...
struct miwu_io_params {
	...
	struct npcm4xx_wui wui; /** Wake-up input source of GPIO */
};
 ...
 *
 * Note: To help setting it, see npcm4xx_miwu_init_dev_callback() below
 */
 ...
 * @param mode Interrupt mode supported by NPCM4XX MIWU
 * @param trig Interrupt trigger mode supported by NPCM4XX MIWU
 *
 ...
 * @retval -EINVAL Invalid parameters
 */
int npcm4xx_miwu_manage_gpio_callback(struct miwu_io_callback *callback, bool set);
...
#endif
#endif /* _NUVOTON_NPCM4XX_SOC_MIWU_H_ */
