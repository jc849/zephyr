...
#define NPCM4XX_I3C_MCONFIG_ODBAUD	FIELD(16, 23)
#define NPCM4XX_I3C_MCONFIG_PPLOW	FIELD(12, 15)
#define NPCM4XX_I3C_MCONFIG_PPBAUD	FIELD(8, 11)
#define NPCM4XX_I3C_MCONFIG_ODSTOP	6
#define NPCM4XX_I3C_MCONFIG_DISTO	3
#define NPCM4XX_I3C_MCONFIG_MSTENA	FIELD(0, 1)
#define NPCM4XX_I3C_CONFIG_SADDR		FIELD(25, 31)
#define NPCM4XX_I3C_CONFIG_BAMATCH		FIELD(16, 22)
...
#define NPCM4XX_I3C_STATUS_TIMECTRL			FIELD(30, 31)
#define NPCM4XX_I3C_STATUS_ACTSTATE			FIELD(28, 29)
#define NPCM4XX_I3C_STATUS_HJDIS			27
#define NPCM4XX_I3C_STATUS_MRDIS			25
#define NPCM4XX_I3C_STATUS_IBIDIS			24
#define NPCM4XX_I3C_STATUS_EVDET			FIELD(20, 21)
...
#define NPCM4XX_I3C_CTRL_VENDINFO		FIELD(24, 31)
#define NPCM4XX_I3C_CTRL_ACTSTATE		FIELD(20, 21)
#define NPCM4XX_I3C_CTRL_PENDINT		FIELD(16, 19)
#define NPCM4XX_I3C_CTRL_IBIDATA		FIELD(8, 15)
#define NPCM4XX_I3C_CTRL_EXTDATA		3
#define NPCM4XX_I3C_CTRL_EVENT			FIELD(0, 1)
...
#define NPCM4XX_I3C_DMACTRL_DMAWIDTH		FIELD(4, 5)
#define NPCM4XX_I3C_DMACTRL_DMATB			FIELD(2, 3)
#define NPCM4XX_I3C_DMACTRL_DMAFB			FIELD(0, 1)
#define NPCM4XX_I3C_DATACTRL_RXEMPTY	31
#define NPCM4XX_I3C_DATACTRL_TXFULL		30
#define NPCM4XX_I3C_DATACTRL_RXCOUNT	FIELD(24, 28)
#define NPCM4XX_I3C_DATACTRL_TXCOUNT	FIELD(16, 20)
#define NPCM4XX_I3C_DATACTRL_RXTRIG		FIELD(6, 7)
#define NPCM4XX_I3C_DATACTRL_TXTRIG		FIELD(4, 5)
...
#define NPCM4XX_I3C_WDATAB_DATA				FIELD(0, 7)
#define NPCM4XX_I3C_WDATABE_DATA		FIELD(0, 7)
#define NPCM4XX_I3C_WDATAH_END		16
#define NPCM4XX_I3C_WDATAH_DATA1	FIELD(8, 15)
#define NPCM4XX_I3C_WDATAH_DATA0	FIELD(0, 7)
#define NPCM4XX_I3C_WDATAHE_DATA1		FIELD(8, 15)
#define NPCM4XX_I3C_WDATAHE_DATA0		FIELD(0, 7)
#define NPCM4XX_I3C_RDATAB_DATA0	FIELD(0, 7)
#define NPCM4XX_I3C_RDATAH_DATA1		FIELD(8, 15)
#define NPCM4XX_I3C_RDATAH_DATA0		FIELD(0, 7)
#define NPCM4XX_I3C_WDATAB1_DATA	FIELD(0, 7)
#define NPCM4XX_I3C_CAPABILITIES_DMA		31
#define NPCM4XX_I3C_CAPABILITIES_INT		30
#define NPCM4XX_I3C_CAPABILITIES_FIFORX		FIELD(28, 29)
#define NPCM4XX_I3C_CAPABILITIES_FIFOTX		FIELD(26, 27)
#define NPCM4XX_I3C_CAPABILITIES_TIMECTRL	21
#define NPCM4XX_I3C_CAPABILITIES_IBI_MR_HJ	FIELD(16, 20)
#define NPCM4XX_I3C_CAPABILITIES_CCCHANDLE	FIELD(12, 15)
#define NPCM4XX_I3C_CAPABILITIES_SADDR		FIELD(10, 11)
#define NPCM4XX_I3C_CAPABILITIES_HDRSUPP	6
#define NPCM4XX_I3C_CAPABILITIES_IDREG		FIELD(2, 5)
#define NPCM4XX_I3C_CAPABILITIES_IDENA		FIELD(0, 1)
#define NPCM4XX_I3C_DYNADDR_DADDR		FIELD(1, 7)
#define NPCM4XX_I3C_DYNADDR_DAVALID		0
#define NPCM4XX_I3C_MAXLIMITS_MAXWR	FIELD(16, 27)
#define NPCM4XX_I3C_MAXLIMITS_MAXRD	FIELD(0, 11)
#define NPCM4XX_I3C_PARTNO_PARTNO		FIELD(0, 31)
#define NPCM4XX_I3C_IDEXT_BCR		FIELD(16, 23)
#define NPCM4XX_I3C_IDEXT_DCR		FIELD(8, 15)
#define NPCM4XX_I3C_VENDORID_VID		FIELD(0, 14)
#define NPCM4XX_I3C_TCCLOCK_FREQ			FIELD(8, 15)
#define NPCM4XX_I3C_TCCLOCK_ACCURACY		FIELD(0, 7)
#define NPCM4XX_I3C_MCTRL_RDTERM	FIELD(16, 23)
#define NPCM4XX_I3C_MCTRL_ADDR		FIELD(9, 15)
#define NPCM4XX_I3C_MCTRL_DIR		8
#define NPCM4XX_I3C_MCTRL_IBIRESP	FIELD(6, 7)
#define NPCM4XX_I3C_MCTRL_TYPE		FIELD(4, 5)
#define NPCM4XX_I3C_MCTRL_REQUEST	FIELD(0, 2)
#define NPCM4XX_I3C_MSTATUS_IBIADDR		FIELD(24, 30)
...
#define NPCM4XX_I3C_MSTATUS_IBITYPE		FIELD(6, 7)
#define NPCM4XX_I3C_MSTATUS_NACKED		5
#define NPCM4XX_I3C_MSTATUS_BETWEEN		4
#define NPCM4XX_I3C_MSTATUS_STATE		FIELD(0, 2)
#define NPCM4XX_I3C_IBIRULES_NOBYTE	31
#define NPCM4XX_I3C_IBIRULES_MSB0	30
#define NPCM4XX_I3C_IBIRULES_ADDR4	FIELD(24, 29)
#define NPCM4XX_I3C_IBIRULES_ADDR3	FIELD(18, 23)
#define NPCM4XX_I3C_IBIRULES_ADDR2	FIELD(12, 17)
#define NPCM4XX_I3C_IBIRULES_ADDR1	FIELD(6, 11)
#define NPCM4XX_I3C_IBIRULES_ADDR0	FIELD(0, 5)
...
#define NPCM4XX_I3C_MDMACTRL_DMAWIDTH	FIELD(4, 5)
#define NPCM4XX_I3C_MDMACTRL_DMATB		FIELD(2, 3)
#define NPCM4XX_I3C_MDMACTRL_DMAFB		FIELD(0, 1)
#define NPCM4XX_I3C_MDATACTRL_RXEMPTY		31
#define NPCM4XX_I3C_MDATACTRL_TXFULL		30
#define NPCM4XX_I3C_MDATACTRL_RXCOUNT		FIELD(24, 28)
#define NPCM4XX_I3C_MDATACTRL_TXCOUNT		FIELD(16, 20)
#define NPCM4XX_I3C_MDATACTRL_RXTRIG		FIELD(6, 7)
#define NPCM4XX_I3C_MDATACTRL_TXTRIG		FIELD(4, 5)
...
#define NPCM4XX_I3C_MWDATAB_DATA		FIELD(0, 7)
#define NPCM4XX_I3C_MWDATABE_DATA	FIELD(0, 7)
#define NPCM4XX_I3C_MWDATAH_END			16
#define NPCM4XX_I3C_MWDATAH_DATA1		FIELD(8, 15)
#define NPCM4XX_I3C_MWDATAH_DATA0		FIELD(0, 7)
#define NPCM4XX_I3C_MWDATAHE_DATA1			FIELD(8, 15)
#define NPCM4XX_I3C_MWDATAHE_DATA0			FIELD(0, 7)
#define NPCM4XX_I3C_MRDATAB_DATA		FIELD(0, 7)
#define NPCM4XX_I3C_MRDATAH_DATA1	FIELD(8, 15)
#define NPCM4XX_I3C_MRDATAH_DATA0	FIELD(0, 7)
#define NPCM4XX_I3C_MWDATAB1_DATA		FIELD(0, 7)
#define NPCM4XX_I3C_MWMSG_SDR_CONTROL_LEN	FIELD(11, 15)
...
#define NPCM4XX_I3C_MWMSG_SDR_DATA_DATA16B		FIELD(0, 15)
#define NPCM4XX_I3C_MRMSG_SDR_DATA			FIELD(0, 15)
#define NPCM4XX_I3C_MWMSG_DDR_CONTROL_END		14
#define NPCM4XX_I3C_MWMSG_DDR_CONTROL_LEN		FIELD(0, 9)
#define NPCM4XX_I3C_MWMSG_DDR_CONTROL_ADDR	FIELD(9, 15)
#define NPCM4XX_I3C_MWMSG_DDR_CONTROL_DIR	7
#define NPCM4XX_I3C_MWMSG_DDR_CONTROL_CMD	FIELD(0, 6)
#define NPCM4XX_I3C_MWMSG_DDR_DATA_DATA16B		FIELD(0, 15)
#define NPCM4XX_I3C_MRMSG_DDR_DATA			FIELD(0, 15)
...
#define NPCM4XX_I3C_HDRCMD_CMD0		FIELD(0, 7)
#define NPCM4XX_I3C_IBIEXT1_EXT3		FIELD(24, 31)
#define NPCM4XX_I3C_IBIEXT1_EXT2		FIELD(16, 23)
#define NPCM4XX_I3C_IBIEXT1_EXT1		FIELD(8, 15)
#define NPCM4XX_I3C_IBIEXT1_MAX			FIELD(4, 6)
#define NPCM4XX_I3C_IBIEXT1_CNT			FIELD(0, 2)
#define NPCM4XX_I3C_IBIEXT2_EXT7			FIELD(24, 31)
#define NPCM4XX_I3C_IBIEXT2_EXT6			FIELD(16, 23)
#define NPCM4XX_I3C_IBIEXT2_EXT5			FIELD(8, 15)
#define NPCM4XX_I3C_IBIEXT2_EXT4			FIELD(0, 7)
#define NPCM4XX_I3C_SID_ID				FIELD(0, 31)
