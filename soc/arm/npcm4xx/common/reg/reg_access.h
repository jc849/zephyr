...
#ifndef _NUVOTON_NPCM4XX_REG_ACCESS_H
#define _NUVOTON_NPCM4XX_REG_ACCESS_H

/*
 * NPCM4XX register bit/field access operations
 */
...
#endif /* _NUVOTON_NPCM4XX_REG_ACCESS_H */
