...
/* DEVALTC, DEV_CTL3 */
SIG_DEFINE(SPIP_CS, A12, SIG_DESC_SET(0x1c, 1))
SIG_DEFINE(SPIP_SCLK, D12, SIG_DESC_SET(0x1c, 1))
SIG_DEFINE(SPIP_DIO0, C12, SIG_DESC_SET(0x1c, 1))
SIG_DEFINE(SPIP_DIO1, B12, SIG_DESC_SET(0x1c, 1))
SIG_DEFINE(SPIP_DIO2, A11, SIG_DESC_SET(0x1c, 1), SIG_DESC_CLEAR(0x04, 2))
SIG_DEFINE(SPIP_DIO3, A10, SIG_DESC_SET(0x1c, 1))
#endif
